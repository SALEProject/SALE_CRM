<?php /* Smarty version 2.6.11, created on 2015-01-14 10:42:08
         compiled from cache/modules/Accounts/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Accounts/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/Accounts/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/Accounts/SearchForm_basic.tpl', 44, false),array('function', 'html_options', 'cache/modules/Accounts/SearchForm_basic.tpl', 107, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/SearchForm_basic.tpl', 151, false),array('modifier', 'count', 'cache/modules/Accounts/SearchForm_basic.tpl', 138, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='codagentie_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CODAGENTIE','module' => 'Accounts'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['codagentie_c_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['codagentie_c_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['codagentie_c_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['codagentie_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['codagentie_c_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='Aici se introduce codul agentiei'      accesskey='9'  >
   	   	</td>
...
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='stareagentie_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STAREAGENTIE','module' => 'Accounts'), $this);?>
</label>
    	</td>
...
<?php echo smarty_function_html_options(array('id' => 'stareagentie_c_basic','name' => 'stareagentie_c_basic[]','options' => $this->_tpl_vars['fields']['stareagentie_c_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['stareagentie_c_basic']['value']), $this);?>
