<?php /* Smarty version 2.6.11, created on 2015-02-09 13:51:22
         compiled from cache/modules/Bugs/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Bugs/EditView.tpl', 46, false),array('function', 'counter', 'cache/modules/Bugs/EditView.tpl', 52, false),array('function', 'sugar_getimagepath', 'cache/modules/Bugs/EditView.tpl', 55, false),array('function', 'sugar_translate', 'cache/modules/Bugs/EditView.tpl', 58, false),array('function', 'html_options', 'cache/modules/Bugs/EditView.tpl', 133, false),array('modifier', 'default', 'cache/modules/Bugs/EditView.tpl', 51, false),array('modifier', 'strip_semicolon', 'cache/modules/Bugs/EditView.tpl', 69, false),array('modifier', 'lookup', 'cache/modules/Bugs/EditView.tpl', 158, false),array('modifier', 'count', 'cache/modules/Bugs/EditView.tpl', 238, false),)), $this); ?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['bug_number']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['bug_number']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['bug_number']['value']);  endif; ?> 
...
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['fixed_in_release']['options']);  ob_start();  echo $this->_tpl_vars['fields']['fixed_in_release']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['fixed_in_release']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['fixed_in_release']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['fixed_in_release']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['fixed_in_release']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['fixed_in_release']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['fixed_in_release']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'bug_number\', \'int\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NUMBER','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'type\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'priority\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORITY','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'resolution\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESOLUTION','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'work_log\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_WORK_LOG','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'found_in_release\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FOUND_IN_RELEASE','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'release_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FOUND_IN_RELEASE','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'fixed_in_release\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FIXED_IN_RELEASE','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'fixed_in_release_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FIXED_IN_RELEASE','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'source\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SOURCE','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'product_category\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRODUCT_CATEGORY','module' => 'Bugs','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Bugs','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Bugs','for_js' => true), $this); echo '\', \'assigned_user_id\' );
