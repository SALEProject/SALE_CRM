...
, "single", true);'><img src="themes/default/images/id-ff-select.png?v=zDP-J9j-z7Oz3JofWH2ifw"     alt="Select" /></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['reports_to_name']['name']; ?>
...
"><img src="themes/default/images/id-ff-clear.png?v=zDP-J9j-z7Oz3JofWH2ifw"     alt="Clear" /></button></span><?php else:  echo $this->_tpl_vars['fields']['reports_to_name']['value']; ?>
<input accesskey=""  tabindex="0"  type="hidden" name="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['reports_to_id']['value']; ?>
"><?php endif; ?>
