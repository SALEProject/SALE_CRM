<?php /* Smarty version 2.6.11, created on 2015-01-21 14:40:07
         compiled from cache/modules/Calls/CalendarEditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Calls/CalendarEditView.tpl', 6, false),array('function', 'counter', 'cache/modules/Calls/CalendarEditView.tpl', 12, false),array('function', 'sugar_translate', 'cache/modules/Calls/CalendarEditView.tpl', 18, false),array('function', 'html_options', 'cache/modules/Calls/CalendarEditView.tpl', 52, false),array('function', 'sugar_getimagepath', 'cache/modules/Calls/CalendarEditView.tpl', 80, false),array('function', 'sugar_getimage', 'cache/modules/Calls/CalendarEditView.tpl', 487, false),array('function', 'sugar_getjspath', 'cache/modules/Calls/CalendarEditView.tpl', 495, false),array('modifier', 'strip_semicolon', 'cache/modules/Calls/CalendarEditView.tpl', 19, false),array('modifier', 'lookup', 'cache/modules/Calls/CalendarEditView.tpl', 77, false),array('modifier', 'count', 'cache/modules/Calls/CalendarEditView.tpl', 157, false),array('modifier', 'default', 'cache/modules/Calls/CalendarEditView.tpl', 525, false),)), $this); ?>
...
<script type="text/javascript">
addForm(\'CalendarEditView\');addToValidate(\'CalendarEditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Calls','for_js' => true), $this); echo '\' );
...
addToValidate(\'CalendarEditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'duration_hours\', \'int\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DURATION_HOURS','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'duration_minutes\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DURATION_MINUTES','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'date_start_date\', \'date\', true,\'Data de începere\' );
addToValidate(\'CalendarEditView\', \'date_end_date\', \'date\', false,\'Data de terminare\' );
addToValidate(\'CalendarEditView\', \'parent_type\', \'parent_type\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PARENT_TYPE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'parent_name\', \'parent\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'status\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'direction\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DIRECTION','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'parent_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO_ID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'reminder_checked\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REMINDER','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'reminder_time\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REMINDER_TIME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'email_reminder_checked\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_REMINDER','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'email_reminder_time\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_REMINDER_TIME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'email_reminder_sent\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_REMINDER_SENT','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'outlook_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OUTLOOK_ID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'accept_status\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCEPT_STATUS','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'set_accept_links\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCEPT_LINK','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'contact_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_NAME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'repeat_type\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPEAT_TYPE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'repeat_interval\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPEAT_INTERVAL','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'repeat_dow\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPEAT_DOW','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'repeat_until\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPEAT_UNTIL','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'repeat_count\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPEAT_COUNT','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'repeat_parent_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPEAT_PARENT_ID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'CalendarEditView\', \'recurring_source\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RECURRING_SOURCE','module' => 'Calls','for_js' => true), $this); echo '\' );
...
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'CalendarEditView_parent_name\']={"form":"CalendarEditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Nu s-au g\\u0103sit \\u00eenregistr\\u0103ri"};sqs_objects[\'CalendarEditView_assigned_user_name\']={"form":"CalendarEditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Nu s-au g\\u0103sit \\u00eenregistr\\u0103ri"};</script>'; ?>
