<?php /* Smarty version 2.6.11, created on 2015-02-09 13:49:03
         compiled from cache/modules/Project/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Project/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/Project/DetailView.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/modules/Project/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/modules/Project/DetailView.tpl', 44, false),array('modifier', 'strip_semicolon', 'cache/modules/Project/DetailView.tpl', 58, false),array('modifier', 'escape', 'cache/modules/Project/DetailView.tpl', 193, false),array('modifier', 'url2html', 'cache/modules/Project/DetailView.tpl', 193, false),array('modifier', 'nl2br', 'cache/modules/Project/DetailView.tpl', 193, false),)), $this); ?>
...
" id="delete_button" class="button" onclick="var _form = document.getElementById('formDetailView');<?php if ($this->_tpl_vars['IS_TEMPLATE']): ?>_form.return_module.value='Project'; _form.return_action.value='ProjectTemplatesListView'; _form.action.value='Delete'; if (confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
')) _form.submit();<?php else: ?>_form.return_module.value='Project'; _form.return_action.value='ListView'; _form.action.value='Delete'; if (confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
')) _form.submit();<?php endif; ?>;_form.submit();" type="button" value="<?php echo $this->_tpl_vars['APP']['LBL_DELETE_BUTTON_LABEL']; ?>
...
<table id='LBL_PROJECT_INFORMATION' class="panelContainer" cellspacing='<?php echo $this->_tpl_vars['gridline']; ?>
'>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['estimated_start_date']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_START','module' => 'Project'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['estimated_start_date']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['estimated_start_date']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['estimated_start_date']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['estimated_start_date']['value']);  endif; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['estimated_end_date']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_END','module' => 'Project'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['estimated_end_date']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['estimated_end_date']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['estimated_end_date']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['estimated_end_date']['value']);  endif; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['assigned_user_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Project'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['created_by_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Project'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%' colspan='3' >
