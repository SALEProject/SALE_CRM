...
{capture name="label" assign="label"}{sugar_translate label='LBL_CODAGENTIE' module='Accounts'}{/capture}
...
{if strlen($fields.codagentie_c.value) <= 0}
{assign var="value" value=$fields.codagentie_c.default_value }
{else}
{assign var="value" value=$fields.codagentie_c.value }
{/if}  
<input type='text' name='{$fields.codagentie_c.name}' 
id='{$fields.codagentie_c.name}' size='30' 
maxlength='255' 
value='{$value}' title='Aici se introduce codul agentiei'      accesskey='7'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CODFISCAL' module='Accounts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.codfiscal_c.value) <= 0}
{assign var="value" value=$fields.codfiscal_c.default_value }
{else}
{assign var="value" value=$fields.codfiscal_c.value }
{/if}  
<input type='text' name='{$fields.codfiscal_c.name}' 
id='{$fields.codfiscal_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='codregistrucomert_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_CODREGISTRUCOMERT' module='Accounts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.codregistrucomert_c.value) <= 0}
{assign var="value" value=$fields.codregistrucomert_c.default_value }
{else}
{assign var="value" value=$fields.codregistrucomert_c.value }
{/if}  
<input type='text' name='{$fields.codregistrucomert_c.name}' 
id='{$fields.codregistrucomert_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TERMINALSUPERVIZOR' module='Accounts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.terminalsupervizor_c.value) <= 0}
{assign var="value" value=$fields.terminalsupervizor_c.default_value }
{else}
{assign var="value" value=$fields.terminalsupervizor_c.value }
{/if}  
<input type='text' name='{$fields.terminalsupervizor_c.name}' 
id='{$fields.terminalsupervizor_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_IBAN' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.iban_c.value) <= 0}
{assign var="value" value=$fields.iban_c.default_value }
{else}
{assign var="value" value=$fields.iban_c.value }
{/if}  
<input type='text' name='{$fields.iban_c.name}' 
id='{$fields.iban_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='banca_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_BANCA' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.banca_c.value) <= 0}
{assign var="value" value=$fields.banca_c.default_value }
{else}
{assign var="value" value=$fields.banca_c.value }
{/if}  
<input type='text' name='{$fields.banca_c.name}' 
id='{$fields.banca_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_STAREAGENTIE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
<select name="{$fields.stareagentie_c.name}" 
id="{$fields.stareagentie_c.name}" 
title=''       
>
{if isset($fields.stareagentie_c.value) && $fields.stareagentie_c.value != ''}
{html_options options=$fields.stareagentie_c.options selected=$fields.stareagentie_c.value}
{else}
{html_options options=$fields.stareagentie_c.options selected=$fields.stareagentie_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.stareagentie_c.options }
{capture name="field_val"}{$fields.stareagentie_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.stareagentie_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.stareagentie_c.name}" 
id="{$fields.stareagentie_c.name}" 
title=''          
>
{if isset($fields.stareagentie_c.value) && $fields.stareagentie_c.value != ''}
...
<input
id="{$fields.stareagentie_c.name}-input"
name="{$fields.stareagentie_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.stareagentie_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.stareagentie_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.stareagentie_c.name}-input', '{$fields.stareagentie_c.name}');sync_{$fields.stareagentie_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.stareagentie_c.name}{literal}");
...
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.stareagentie_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.stareagentie_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.stareagentie_c.name}');
{literal}
...
//global variable 
sync_{/literal}{$fields.stareagentie_c.name}{literal} = function(){
SyncToHidden();
}
...
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.stareagentie_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.stareagentie_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_RINGURI' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<input type="hidden" id="{$fields.ringuri_c.name}_multiselect"
name="{$fields.ringuri_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.ringuri_c.value default=$fields.ringuri_c.default assign="values"}
<select id="{$fields.ringuri_c.name}"
name="{$fields.ringuri_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.ringuri_c.options selected=$values}
</select>
{else}
{assign var="field_options" value=$fields.ringuri_c.options }
{capture name="field_val"}{$fields.ringuri_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.ringuri_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<input type="hidden" id="{$fields.ringuri_c.name}_multiselect"
name="{$fields.ringuri_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.ringuri_c.value default=$fields.ringuri_c.default assign="values"}
<select style='display:none' id="{$fields.ringuri_c.name}"
name="{$fields.ringuri_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.ringuri_c.options selected=$values}
...
<input
id="{$fields.ringuri_c.name}-input"
name="{$fields.ringuri_c.name}-input"
size="60"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button">
<img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.ringuri_c.name}-image">
</button>
<button type="button"
id="btn-clear-{$fields.ringuri_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.ringuri_c.name}-input', '{$fields.ringuri_c.name};');SUGAR.AutoComplete.{$ac_key}.inputNode.updateHidden()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.ds = new Y.DataSource.Function({
source: function (request) {
var selectElem = document.getElementById("{/literal}{$fields.ringuri_c.name}{literal}");
var ret = [];
for (i=0;i<selectElem.options.length;i++)
if (!(selectElem.options[i].value=='' && selectElem.options[i].innerHTML==''))
ret.push({'key':selectElem.options[i].value,'text':selectElem.options[i].innerHTML});
...
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.ringuri_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.ringuri_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.ringuri_c.name}');
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
if(SUGAR.AutoComplete.{$ac_key}.numOptions >= 300) {literal}{
...
if (document.activeElement != document.getElementById("{/literal}{$fields.ringuri_c.name}-input{literal}"))
...
addToValidate('EditView', 'terminalsupervizor_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_TERMINALSUPERVIZOR' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'stareagentie_c', 'enum', true,'{/literal}{sugar_translate label='LBL_STAREAGENTIE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'codfiscal_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODFISCAL' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'ringuri_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_RINGURI' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'banca_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BANCA' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'codagentie_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODAGENTIE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'iban_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_IBAN' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'codregistrucomert_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODREGISTRUCOMERT' module='Accounts' for_js=true}{literal}' );
