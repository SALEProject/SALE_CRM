...
addToValidate('form_QuickCreate_Accounts', 'terminalsupervizor_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_TERMINALSUPERVIZOR' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'stareagentie_c', 'enum', true,'{/literal}{sugar_translate label='LBL_STAREAGENTIE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'codfiscal_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODFISCAL' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'ringuri_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_RINGURI' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'banca_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BANCA' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'codagentie_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODAGENTIE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'iban_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_IBAN' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'codregistrucomert_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODREGISTRUCOMERT' module='Accounts' for_js=true}{literal}' );
