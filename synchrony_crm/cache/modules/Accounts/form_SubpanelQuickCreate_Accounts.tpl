...
<div class="buttons">
<div class="action_buttons">{if $bean->aclAccess("save")}<input title="{$APP.LBL_SAVE_BUTTON_TITLE}"  class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Accounts'); disableOnUnloadEditView(); _form.action.value='Save';if(check_form('form_SubpanelQuickCreate_Accounts'))return SUGAR.subpanelUtils.inlineSave(_form.id, 'Accounts_subpanel_save_button');return false;" type="submit" name="Accounts_subpanel_save_button" id="Accounts_subpanel_save_button" value="{$APP.LBL_SAVE_BUTTON_LABEL}">{/if}  <input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate($(this).attr('id'));return false;" type="submit" name="Accounts_subpanel_cancel_button" id="Accounts_subpanel_cancel_button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}">  <input title="{$APP.LBL_FULL_FORM_BUTTON_TITLE}" class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Accounts'); disableOnUnloadEditView(_form); _form.return_action.value='DetailView'; _form.action.value='EditView'; if(typeof(_form.to_pdf)!='undefined') _form.to_pdf.value='0';" type="submit" name="Accounts_subpanel_full_form_button" id="Accounts_subpanel_full_form_button" value="{$APP.LBL_FULL_FORM_BUTTON_LABEL}"> <input type="hidden" name="full_form" value="full_form"> {if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=Accounts", true, false,  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} ); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}<div class="clear"></div></div>
</div>
</form>
{$set_focus_block}
...
addToValidate('form_SubpanelQuickCreate_Accounts', 'terminalsupervizor_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_TERMINALSUPERVIZOR' module='Accounts' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Accounts', 'stareagentie_c', 'enum', true,'{/literal}{sugar_translate label='LBL_STAREAGENTIE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Accounts', 'codfiscal_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODFISCAL' module='Accounts' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Accounts', 'ringuri_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_RINGURI' module='Accounts' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Accounts', 'banca_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BANCA' module='Accounts' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Accounts', 'codagentie_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODAGENTIE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Accounts', 'iban_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_IBAN' module='Accounts' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Accounts', 'codregistrucomert_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CODREGISTRUCOMERT' module='Accounts' for_js=true}{literal}' );
