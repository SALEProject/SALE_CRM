...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='codagentie_c_basic' >{sugar_translate label='LBL_CODAGENTIE' module='Accounts'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.codagentie_c_basic.value) <= 0}
{assign var="value" value=$fields.codagentie_c_basic.default_value }
{else}
{assign var="value" value=$fields.codagentie_c_basic.value }
{/if}  
<input type='text' name='{$fields.codagentie_c_basic.name}' 
    id='{$fields.codagentie_c_basic.name}' size='30' 
    maxlength='255' 
    value='{$value}' title='Aici se introduce codul agentiei'      accesskey='9'  >
   	   	</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='stareagentie_c_basic' >{sugar_translate label='LBL_STAREAGENTIE' module='Accounts'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='stareagentie_c_basic' name='stareagentie_c_basic[]' options=$fields.stareagentie_c_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.stareagentie_c_basic.value}
   	   	</td>
