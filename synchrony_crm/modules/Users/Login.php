...
if ( sugar_is_file('custom/include/images/sugar_md.png') ) {
    ...
    $login_image = '<IMG src="index.php?entryPoint=getImage&themeName=BRM&themeName=BRM&imageName=login_title.png" alt="Synchrony CRM" width="400" height="90" style="margin: 5px 0;">';
}
